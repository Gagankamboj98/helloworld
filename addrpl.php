                ...
                <div class="app-main__outer">
                    <div class="app-main__inner">
                      ...
                      <div class="main-card mb-3 card">
                            <div class="card-body">
                                <h5 class="card-title">RPL PROCESS? </h5>
                                
								<form class="needs-validation" novalidate="" action="inc/process.php?action=AddRpl" method="post">
								 <input type = "hidden" name="id" value="<?php echo $RPL['id'];?>" required/>
                                    <div class="form-row">
										...
										<div class="form-row">
                                        <div class="col-md-12 mb-12">
                                            <label for="validationCustom02">Title2</label>
											<input  name="title2" class="form-control" id="validationCustom020"> 
                                             <div class="valid-feedback">
                                                Looks good!
                                            </div>
                                        </div>
									 ...
									 <div class="form-row">
                                        <div class="col-md-12 mb-12">
											...
											<textarea cols="100" rows="5" name="content" class="form-control" id="validationCustom02"> </textarea>
                                             <div class="valid-feedback">
                                                Looks good!
                                            </div>
                                        </div>
